    ...
    <div className="max-w-5xl mx-auto px-4 py-6 space-y-6">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          ...
          className="shrink-0 px-3 py-1.5 text-xs border border-gray-200 dark:border-gray-700 rounded text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-200 transition-colors"
        >
          リセット
        </button>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-4 items-start">
        ...
        <div className="w-full md:w-5/12 space-y-3">
          {groupedMatches.length === 0 ? (
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded shadow-sm p-6 text-center text-sm text-gray-400 dark:text-gray-500">
              予定試合データがありません
            </div>
          ) : (
            groupedMatches.map(([matchday, matches]) => (
              <div
                key={matchday}
                className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded shadow-sm overflow-hidden"
              >
                <div className="px-3 py-2 bg-gray-50 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-800">
                ...
                <ul>
                  {matches.map((m) => {
                    ...
                    return (
                      <li
                        key={m.matchId}
                        className="px-3 py-2.5 border-b border-gray-100 dark:border-gray-800 last:border-0"
                      >
                            ...
                            {(["H", "D", "A"] as const).map((opt) => (
                              <button
                                ...
                                className={`w-7 h-7 text-xs font-bold rounded transition-colors ${
                                  pred === opt
                                    ? BTN_STYLES[opt]
                                    : "bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-gray-400 dark:text-gray-500 hover:bg-gray-50 dark:hover:bg-gray-800"
                                }`}
                              >
                                {opt}
                              </button>
        ...
        <div className="w-full md:w-7/12">
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded shadow-sm overflow-hidden">
            ...
            <table className="w-full text-xs border-collapse">
              <thead>
                <tr className="bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                  ...
                  <tr
                    ...
                    className={`border-b border-gray-100 dark:border-gray-800 last:border-0 transition-colors ${
                      hasPredictions && r.positionChange !== 0
                        ? "bg-pn-blue-light/30 dark:bg-blue-950/20"
                        : "hover:bg-gray-50 dark:hover:bg-gray-800"
                    } ${getZoneBorder(r.predictedPosition)}`}
                  >
                    {/* 予測順位 */}
                    <td className="px-2 py-2 text-center font-mono tabular-nums text-gray-500 dark:text-gray-400">
                      {r.predictedPosition}
                    </td>
                    {/* 変動 */}
                    ...
                    {/* 現在勝点 */}
                    <td className="px-2 py-2 text-center font-mono tabular-nums text-gray-400 dark:text-gray-500">
                      {r.currentPoints}
                    </td>
                    {/* 予測勝点 */}
                    <td className="px-2 py-2 text-center font-mono tabular-nums font-semibold text-gray-900 dark:text-gray-100">
                      {r.predictedPoints}
                      {r.predictedPoints > r.currentPoints && (
                    ...
                    {/* 残試合 */}
                    <td className="px-2 py-2 text-center font-mono tabular-nums text-gray-400 dark:text-gray-500 hidden sm:table-cell">
                      {r.remainingMatches}
                    </td>
                  </tr>
                ))}
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded shadow-sm p-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded p-3 text-center">
            <p className="text-gray-500 dark:text-gray-400 mb-1">予測入力</p>
            <p className="font-mono tabular-nums font-semibold text-gray-900 dark:text-gray-100 text-base">
              {totalPredictions}
          ...
          {/* 最も勝点が増えるチーム */}
          <div className="bg-gray-50 dark:bg-gray-800 rounded p-3 text-center">
            <p className="text-gray-500 dark:text-gray-400 mb-1">最多獲得</p>
          ...
          {/* 最大上昇 */}
          <div className="bg-gray-50 dark:bg-gray-800 rounded p-3 text-center">
            <p className="text-gray-500 dark:text-gray-400 mb-1">最大上昇</p>
          ...
          {/* 最大下降 */}
          <div className="bg-gray-50 dark:bg-gray-800 rounded p-3 text-center">
            <p className="text-gray-500 dark:text-gray-400 mb-1">最大下降</p>
